...
void display()
{
    ...
    glBegin(GL_QUADS);
    glColor3ub(203, 212, 137);
    glVertex2f(0.0,71.0);
    glColor3ub(127, 212, 239);
    glVertex2f(0.0,750.0);
    glColor3ub(127, 212, 239);
    glVertex2f(1080.0,750.0);
    glColor3ub(203, 212, 137);
    glVertex2f(1080.0,71.0);
    glEnd();
    ...
    glPushMatrix();
    glTranslatef(0.0,_moveSun,0.0);
    glBegin(GL_POLYGON);
    glColor3ub(252, 181, 77);
    for (int i =0;i < 360;i++)
    {
        double theta;
        theta = i * 3.1416 / 180;
    ...
    glVertex2f(0.0,0.0);
    glVertex2f(0.0,35.0);
    glVertex2f(1080.0,35.0);
    glVertex2f(1080.0,0.0);
    glEnd();
